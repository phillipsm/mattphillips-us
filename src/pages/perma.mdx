...
<img src="/assets/perma/process-overview-v2@2x.png" alt="Diagram of the design process — turning up variance to avoid local maxima" width="3186" height="1880" loading="lazy" />
<p class="img-desc">Avoid local maxima by dialing up the variance.</p>
